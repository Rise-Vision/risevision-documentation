...
| **requestTicket**  |  **NO**  | [Request ticket]({{site.hashTag}}developer/viewer-api/notifications/signals) received from the channel. |
...
`ping_interval` is the interval (in minutes) between({{site.hashTag}}ping signals](developer/viewer-api/notifications/signals) sent to the Viewer over the channel (default is 30).
...
`ping_interval` is the interval (in m({{site.hashTag}}utes) between [ping signals](developer/viewer-api/notifications/signals) sent to the Viewer over the channel (default is 30).
...
`ping_interval` is the({{site.hashTag}}nterval (in minutes) between [ping signals](developer/viewer-api/notifications/signals) sent to the Viewer over the channel (default is 30).
...
`ping_i({{site.hashTag}}erval` is the interval (in minutes) between [ping signals](developer/viewer-api/notifications/signals) sent to the Viewer over the channel (default is 30).
...
`ping_interval` is the interval (in minutes) between [ping signals](developer/viewer-api/notifications/signals) sent to the Viewer over the channel (default is 30).
