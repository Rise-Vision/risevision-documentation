...
Next select the operating system [Windows](user/display/chrome-player-windows), [Chrome OS](user/display/configure-kiosk-mode), [Ubuntu](user/display/chrome-player-linux) or [Mac OS X](user/display/chrome-player-mac) you are using and optimize it for digital signage according to their respective guides.
